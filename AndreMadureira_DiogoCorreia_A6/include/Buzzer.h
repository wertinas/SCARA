...
#define FREQ_TIMER 125001
// uint8_t PLAYERWIN = 1;

enum t2_prescaler{
  T2_PRESCALER_1    = (1 << CS20),
  T2_PRESCALER_8    = (2 << CS20),
  T2_PRESCALER_32   = (3 << CS20),
  T2_PRESCALER_64   = (4 << CS20),
  T2_PRESCALER_128  = (5 << CS20),
  T2_PRESCALER_256  = (6 << CS20),
  T2_PRESCALER_1024 = (7 << CS20),
};
